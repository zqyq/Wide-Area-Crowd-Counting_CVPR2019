...
def datagen_v3(h5file_view1, h5file_view2, h5file_view3,
    ...
    while 1:
        ...
        if nb_patch_used + batch_size < patches_per_set + 1: #or (ind_image == 0 and nb_patch_used == 0):
            ...
            img4_s0 = images4[n, :, :, 0]
            img4_s1 = cv2.resize(img4_s0, (img4_s0.shape[1]/2, img4_s0.shape[0]/2))
            img4_s2 = cv2.resize(img4_s1, (img4_s1.shape[1]/2, img4_s1.shape[0]/2))

            img4_s0 = np.expand_dims(img4_s0, axis=0)
            img4_s0 = np.expand_dims(img4_s0, axis=3)
            img4_s1 = np.expand_dims(img4_s1, axis=0)
            img4_s1 = np.expand_dims(img4_s1, axis=3)
            img4_s2 = np.expand_dims(img4_s2, axis=0)
            img4_s2 = np.expand_dims(img4_s2, axis=3)

            X_list.append(img4_s0)
            X_list.append(img4_s1)
            X_list.append(img4_s2)
            ...
            X_list.append(view4_image_depth_resized_log2)
            ...
            dmap5 = conv_process_batch(dmap5, pad=0, stride=4, filter_size=4)*1000
