...
def feature_extraction_view4(base_weight_decay, x, train_flag):
    x4_1 = Conv2D(
        data_format='channels_last',
        trainable=train_flag,
        filters=16,
    ...
    x4_1 = Activation('relu',
                      #name='conv_block_1_act'
                      )(x4_1)
    x4_1 = AcrossChannelLRN(
        local_size=5,
        alpha=0.01,
        beta=0.75,
        k=1,
    ...
    x4_2 = Activation('relu',
                      #name='conv_block_2_act'
                      )(x4_2)
    x4_2 = AcrossChannelLRN(
        local_size=5,
        alpha=0.01,
        beta=0.75,
        k=1,
    ...
    x4_3 = Activation('relu',
                      #name='conv_block_3_act'
                      )(x4_3)
    x4_3 = AcrossChannelLRN(
        local_size=5,
        alpha=0.01,
        beta=0.75,
        k=1,
    ...
    x4_4 = Activation('relu', #name='conv_block_4_act'
                      )(x4_4)
    x4_4 = AcrossChannelLRN(
        local_size=5,
        alpha=0.01,
        beta=0.75,
        k=1,
...
def fusion_conv_v4(base_weight_decay, x):
    x1_04 = Conv2D(
        data_format='channels_last',
        trainable=True,
        filters=32,
...
def build_model_FCN_model_api(batch_size,
    ...
    input_depth_maps_v4 = Input(batch_shape = input_shape3, name='depth_ratio_v4')
    ...
    ####################### view 1 #############################################
    # image pyramids:
    x1_s0_output = feature_extraction_view1(base_weight_decay, input_patches1_s0, train_flag )
    x1_s1_output = feature_extraction_view1(base_weight_decay, input_patches1_s1, train_flag)
    x1_s2_output = feature_extraction_view1(base_weight_decay, input_patches1_s2, train_flag)
    ...
    ####################### view 2 #############################################
    # image pyramids:
    x2_s0_output = feature_extraction_view2(base_weight_decay, input_patches2_s0, train_flag)
    x2_s1_output = feature_extraction_view2(base_weight_decay, input_patches2_s1, train_flag)
    x2_s2_output = feature_extraction_view2(base_weight_decay, input_patches2_s2, train_flag)
    # view 2 decoder
    ...
    ####################### view 3 #############################################
    # image pyramids:
    x3_s0_output = feature_extraction_view3(base_weight_decay, input_patches3_s0, train_flag)
    x3_s1_output = feature_extraction_view3(base_weight_decay, input_patches3_s1, train_flag)
    x3_s2_output = feature_extraction_view3(base_weight_decay, input_patches3_s2, train_flag)
    ...
    ####################### view 4 #############################################
    # image pyramids:
    x4_s0_output = feature_extraction_view4(base_weight_decay, input_patches4_s0, train_flag)
    x4_s1_output = feature_extraction_view4(base_weight_decay, input_patches4_s1, train_flag)
    x4_s2_output = feature_extraction_view4(base_weight_decay, input_patches4_s2, train_flag)
    ...
    view4_scale_mask = feature_scale_fusion_layer_rbm(scale_number=scale_number)(view4_scale)
    ...
    ## proj
    fusion_v1_proj = SpatialTransformer(1, [int(480/4), int(640/4)])(fusion_v1)
    ...
    ## proj
    fusion_v2_proj = SpatialTransformer(2, [int(480/4), int(640/4)])(fusion_v2)
    ...
    ## proj
    fusion_v3_proj = SpatialTransformer(3, [int(480/4), int(640/4)])(fusion_v3)
    ...
    ## up sampling
    x4_s1_output_fusion = UpSampling_layer(size=[height, width])([x4_s1_output_fusion])
    x4_s2_output_fusion = UpSampling_layer(size=[height, width])([x4_s2_output_fusion])

    concatenated_map_v4 = Concatenate(name='cat_map_v4')(
        [x4_s0_output_fusion, x4_s1_output_fusion, x4_s2_output_fusion])

    fusion_v4 = feature_scale_fusion_layer(scale_number=scale_number)([concatenated_map_v4, view4_scale_mask])

    ## proj
    fusion_v4_proj = SpatialTransformer(4, [int(480/4), int(640/4)])(fusion_v4)



    ################# concatenate ################
    concatenated_map = Concatenate(name='cat_map_fusion')([fusion_v1_proj, fusion_v2_proj, fusion_v3_proj, fusion_v4_proj])
    fusion_v123 = Conv2D(
        data_format='channels_last',
        trainable=True,
        filters=96,
    ...
    if output_ROI_mask:
        ...
        model = Model(inputs = [input_patches1_s0, input_patches1_s1, input_patches1_s2,
                                ...
                                input_depth_maps_v1, input_depth_maps_v2,
                                input_depth_maps_v3, input_depth_maps_v4,
                                output_masks],
                      outputs = [x_output],
                      name=net_name)
    else:
